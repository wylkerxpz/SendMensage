...
public class MainActivity extends ActionBarActivity implements View.OnClickListener{
    ...
    private void displayListView() {
        ...
        etUsername.setText("Ola " + user.usuario_nome);
    ...
    private void buttonClick() {
        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(subject.isEmpty()) {
                    Toast.makeText(getApplicationContext(),"Preencha o assunto", Toast.LENGTH_SHORT)
                            .show();
                } else if(mensage.isEmpty()) {
                    Toast.makeText(getApplicationContext(),"Preencha a mensagem", Toast.LENGTH_SHORT)
                            .show();
                } else if (list.size() == 0) {
                    Toast.makeText(getApplicationContext(), "Selecione alguma disciplina", Toast.LENGTH_SHORT)
                            .show();
                } else {
